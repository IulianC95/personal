...
const texts = {
  ...
  js: [
    ...
    'O functie anonima poate fi executata, dar nu are un nume, ea se poate folosi pe post de callback pentru diferite metode.',
    ...
    'JavaScript fiind orientat pe prototipuri, isi bazeaza mostenirea pe conceptul de prototype chain, in care fiecare obiect are o proprietate numita prototype (__proto__) in care exista o referinta la obiectul de la care mosteneste informatii (proprietati sau metode)',
    ...
    'ES6 Classes este "syntactic sugar" peste o tehnica de JavaScript prin care se poate simula programarea orientata pe obiecte asa cum este ea intalnita in limbaje precum C++ sau Java sau C#.',
