...
adauga_ingredientele('/home/iulian/curs/personal/personal/recipe-finder/src/app/components/core/pages/category/json-files/vegetarian-recipes.json', 'fisier_destinatie.json')
