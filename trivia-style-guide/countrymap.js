...
html5countrymapv4.225 - trial version
...
var simplemaps_countrymap_mapinfo = {
  ...
  default_labels: {},
  proj_coordinates: [
    { lat: 46.4, x: 701.8, lng: 26.883333, y: 293.1 },
    { lat: 47.91667, x: 589.2, lng: 25.816667, y: 57.6 },
    { lat: 47.31667, x: 416.9, lng: 24.183333, y: 151.6 },
  ],
  initial_view: { x2: 1008.99, x: 0.99, y2: 711.04, y: 0.99 },
};
